...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "sub.freeeternal.buzz (freeeternal-提供）": "https://sub.freeeternal.buzz/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://sub.freeeternal.buzz/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://sub.freeeternal.buzz/sub?";
